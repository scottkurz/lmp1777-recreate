...
public class HeightsBean implements java.io.Serializable {
    ...
    public void setHeightFeet(String heightfeet) { 
    	System.out.println("SKSK: in war2, cl =" + this.getClass().getClassLoader());
        this.cm = Integer.valueOf(heightCm);
        // tag::getFeet[]
        this.feet = io.openliberty.guides.multimodules.lib.Converter.getFeet2(cm);
        // end::getFeet[]
    ...
    public void setHeightInches(String heightinches) {
        this.cm = Integer.valueOf(heightCm);
        // tag::getInches[]
        this.inches = io.openliberty.guides.multimodules.lib.Converter.getInches2(cm);
        // end::getInches[]
